...
class UploadImageCommand extends Command
{
    ...
    public function handle()
    {
        try {
            ...
            Log::info('Done couple_informations');
            ...
            Log::error('Command Upload: '. $exception->getMessage());
        }
    }
}
