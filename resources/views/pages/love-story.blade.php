        ...
        <div class="container">
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="next">
                        <a href="{{route('phu-dau')}}">Tiếp theo
                ...
                <div class="box-content">
                            ...
                            <div class="form-info chu_re mb-3">
                                ...
                                <div class="info">
                                    <div class="mt-5">
                                        ...
                                        <el-input v-model="item.tieu_de" ></el-input>
                                    </div>
                                    <div class="mt-3">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <el-input type="textarea" v-model="item.noi_dung" ></el-input>
                                    </div>
                                    <div class="mt-3">
                    ...
                    <div class="text-center action">
                        <el-button class="mb-2" @click="addLoveStory" icon="el-icon-plus" type="success"> THÊM CÂU CHUYỆN </el-button>
    ...
    <script>
        ...
        new Vue({
            ...
            methods: {
                ...
                fetchData() {
                    const url = "{{route('get-love-story')}}";
                ...
                save() {
                    this.loading = true
                    const url = "{{route('post-love-story')}}";
